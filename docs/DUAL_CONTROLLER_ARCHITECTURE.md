...
Обновление 18.09: L2 block identity исправлена через ChainBlocks; текущие размеры
Short 22 368, Monthly 17 445, vault 8 496 bytes. Таблица ниже описывает замер 17.09.
Новый evidence и ограничения: [Nitro semantics](ROBINHOOD_BLOCK_SEMANTICS.md).
