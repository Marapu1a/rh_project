...
Сначала изолировать определённый отказ одного recipient небольшим исправлением,
сохранив fail-closed для неоднозначной отправки. Затем следующая TOKEN-связка должна
