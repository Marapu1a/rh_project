...
Владелец поддержал 100 USDG как минимальный следующий старт и попросил избегать лишних условий вокруг паузы и target. Текущий кандидат для окончательного ревью: **T=100 USDG на весь MVP, без pending target/schedule и без административной pause**. Он заменяет направление обсуждения изменяемого T для следующего цикла; не является уже реализованным monthly transition. Constructor прототипа всё ещё принимает произвольный положительный T.
