...
**Принято 15.09.2026 — воспроизводимый запуск.** PAIR является первой интеграцией, а не обязательной платформой всех будущих экземпляров продукта. Ядро Promo должно допускать независимое повторное развёртывание на другой совместимой площадке с адаптацией источника комиссий и явно объявленных правил финансирования. Это не перенос старой ликвидности, балансов или обязательств и не основание добавлять вывод призовой казны либо изменяемость уже развёрнутых контрактов. Техническая граница и предложенный план: [переносимость и исходники PAIR](PAIR_PORTABILITY_AND_SOURCES_2026-09-15.md).
