...
Обновлено: 13.09.2026, после реализации USDG funding и monthly accounting в PromoVault. Продуктовые параметры draws и creator shares этим не утверждены.
