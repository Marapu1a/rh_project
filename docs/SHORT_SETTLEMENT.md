...
16.09 локальный `npm test`: **136/136 passed**, включая 8 новых тестов settlement.
Runtime `ShortSettlementFixture`: **20 340 байт** при optimizer runs=200, Cancun;
...
Обработка ограничена размером вызова, но суммарная работа растёт с N. Повторный
локальный расчёт корзины/хешей сохраняет накладные расходы study. Новых обещаний
gas-cost или неограниченной доступности исторического RPC нет.
