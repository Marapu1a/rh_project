...
непосредственно в recipient slot 0; существующие CLI/workers не умеют обслуживать converter.
Поэтому A закрыт на уровне нового контрактного пути, но старый несовместимый профиль
...
Ближайший отдельный кусок: подключить converter к локальным funding/revenue jobs,
добавить ограниченное автоматическое обслуживание старых recipients/converters.
Сейчас тест явно вызывает permissionless pay старому recipient после rollover;
это доказывает сохранность долга, но не автоматический поиск/обслуживание истории.
