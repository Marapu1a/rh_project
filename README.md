...
Также реализованы [версии допуска Monthly](docs/MONTHLY_RULES_EPOCHS.md): будущие
правила с notice, сохранение условий старых билетов, независимый replay v4 и проверка
публичного dataset. Периодичность Monthly при обновлении правил не меняется.
